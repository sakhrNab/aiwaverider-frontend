    ...
    <div className={`min-h-screen pb-16 ${darkMode ? "dark bg-[#2D1846]" : "bg-gray-50"} ${themeClasses}`}>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 mt-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="hero-section mb-6 sm:mb-8">
            ...
            <div className="hero-content glass-effect relative z-10 p-6 sm:p-8 lg:p-10">
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                {/* Business Media Kit Link - Subtle */}
                <div className="mt-6">
                  <Link
          ...
          {/* Business Media Kit CTA Section */}
          <div className="mt-12 mb-6 glass-effect p-6 rounded-lg text-center">
            <h3 className={`text-2xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-white'}`}>
              Looking for Enterprise Automation Solutions?
            </h3>
            <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-200'}`}>
              Explore our business media kit with custom workflow packages, case studies, and enterprise automation services.
            </p>
            <Link
              to="/media-kit-business"
