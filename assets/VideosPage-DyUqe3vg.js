import{z as ae,r as s,A as W,j as e,e as oe,K as J,b2 as _,y as I}from"./index-JFQnab3B.js";import{V as Z}from"./videosService-Inw3FqGr.js";const le=r=>{const t=ae();s.useEffect(()=>{const c=`${r} | AIWaverider`;document.title=c;const C=window.history.state;C&&window.history.replaceState({...C,title:c},c,t.pathname+t.search+t.hash)},[r,t])},ne=(r,t=1)=>{const[l,c]=s.useState([]),[C,w]=s.useState(!1),[x,$]=s.useState(null),[a,y]=s.useState(t),[m,h]=s.useState(0),[S,k]=s.useState(0),[u,v]=s.useState(!1),[f,E]=s.useState(!1),i=s.useRef(new Map),M=s.useRef(!0),N=s.useCallback(async n=>{if(!r||typeof r!="string"||r.trim()===""){c([]),w(!1),$(null);return}const p=`${r}-${n}`;if(i.current.has(p)){const d=i.current.get(p);c(d.videos),h(d.totalPages),k(d.totalVideos),v(d.hasNextPage),E(d.hasPreviousPage),y(n);return}w(!0),$(null);try{const d=await Z.getVideosByPlatform(r,n),P={videos:d.videos||[],totalPages:d.totalPages||0,totalVideos:d.totalVideos||0,hasNextPage:d.hasNextPage||!1,hasPreviousPage:d.hasPreviousPage||!1};i.current.set(p,P),c(P.videos),h(P.totalPages),k(P.totalVideos),v(P.hasNextPage),E(P.hasPreviousPage),y(n)}catch(d){$(d.message),console.error(`Error fetching ${r} videos:`,d),c([]),h(0),k(0),v(!1),E(!1)}finally{w(!1)}},[r]),b=s.useCallback(()=>{if(u){const n=a+1;N(n)}},[a,u,N]),V=s.useCallback(()=>{if(f){const n=a-1;N(n)}},[a,f,N]),L=s.useCallback(n=>{n>=1&&n<=m&&N(n)},[m,N]),U=s.useCallback(()=>{if(!r)return;const n=`${r}-${a}`;i.current.delete(n),N(a)},[r,a,N]),A=s.useCallback(()=>{i.current.clear()},[]);return s.useEffect(()=>{r&&typeof r=="string"&&r.trim()!==""&&M.current&&(M.current=!1,N(t))},[r,t,N]),s.useEffect(()=>{r&&typeof r=="string"&&r.trim()!==""?(y(1),M.current=!0,$(null)):(c([]),w(!1),$(null),h(0),k(0),v(!1),E(!1),y(1))},[r]),{videos:l,loading:C,error:x,currentPage:a,totalPages:m,totalVideos:S,hasNextPage:u,hasPreviousPage:f,nextPage:b,previousPage:V,goToPage:L,refresh:U,clearCache:A,isEmpty:l.length===0&&!C,isFirstPage:a===1,isLastPage:a===m}},ie=(r={})=>{const[t,l]=s.useState(!1),[c,C]=s.useState(!1),w=s.useRef(null),x=s.useRef(null),{threshold:$=.1,rootMargin:a="50px",triggerOnce:y=!0,enabled:m=!0}=r,h=s.useCallback(()=>{!m||!w.current||(x.current=new IntersectionObserver(S=>{const[k]=S,u=k.isIntersecting;l(u),u&&!c&&(C(!0),y&&x.current&&x.current.unobserve(w.current))},{threshold:$,rootMargin:a}),x.current.observe(w.current))},[$,a,y,m,c]);return s.useEffect(()=>(h(),()=>{x.current&&x.current.disconnect()}),[h]),s.useEffect(()=>{!m&&x.current?(x.current.disconnect(),l(!1),y&&C(!1)):m&&!x.current&&h()},[m,h,y]),{targetRef:w,isIntersecting:t,hasIntersected:c,shouldLoad:m&&(y?c:t)}},de=(r,t={})=>{const[l,c]=s.useState(null),[C,w]=s.useState(!1),[x,$]=s.useState(!1),{targetRef:a,shouldLoad:y}=ie(t);return s.useEffect(()=>{if(!y||!r||l)return;w(!0),$(!1);const m=new Image;return m.onload=()=>{c(r),w(!1)},m.onerror=()=>{$(!0),w(!1)},m.src=r,()=>{m.onload=null,m.onerror=null}},[y,r,l]),{targetRef:a,imageSrc:l,imageLoading:C,imageError:x,shouldLoad:y}};function ce({title:r,titleId:t,...l},c){return s.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor","aria-hidden":"true","data-slot":"icon",ref:c,"aria-labelledby":t},l),r?s.createElement("title",{id:t},r):null,s.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"}))}const ue=s.forwardRef(ce),D={youtube:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"})}),tiktok:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"})}),instagram:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})},me=r=>{if(!r||typeof r!="string")return null;const t=/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/,l=r.match(t);return l?l[1]:null},xe=r=>{if(!r||typeof r!="string")return null;const t=/tiktok\.com\/.*\/video\/(\d+)/,l=r.match(t);return l?l[1]:null},he=r=>{if(!r||typeof r!="string")return null;const t=/instagram\.com\/(?:p|reel)\/([A-Za-z0-9_-]+)/,l=r.match(t);return l?l[1]:null},X=({video:r,onPlay:t,className:l=""})=>{const{darkMode:c}=W(),{targetRef:C,imageSrc:w,imageLoading:x,imageError:$}=de(r.thumbnailUrl,{threshold:.1,rootMargin:"100px"}),[a,y]=s.useState(r.platform.toLowerCase()==="instagram"),[m,h]=s.useState(!1);s.useCallback(()=>{y(!0),h(!1)},[]);const S=s.useCallback(()=>{h(!0)},[]),k=()=>{if(!a||m)return null;const{platform:b,originalUrl:V}=r;if(!V||typeof V!="string")return h(!0),null;switch(b.toLowerCase()){case"youtube":{const L=me(V);return L?e.jsx("div",{className:"aspect-video w-full",children:e.jsx("iframe",{src:`https://www.youtube.com/embed/${L}?autoplay=1&rel=0`,title:r.title,frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full rounded-lg",onError:S})}):(h(!0),null)}case"tiktok":{const L=xe(V);return L?e.jsx("div",{className:"aspect-[9/16] w-full max-w-lg mx-auto",children:e.jsx("iframe",{src:`https://www.tiktok.com/embed/v2/${L}?autoplay=1`,title:r.title,frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full rounded-lg",onError:S,style:{minHeight:"700px"}})}):(h(!0),null)}case"instagram":{const L=he(V);if(!L)return h(!0),null;const U=V.includes("/reel/"),A=U?"aspect-[9/16]":"aspect-square",n=U?"max-w-md":"max-w-lg";return e.jsxs("div",{className:`${A} ${n} mx-auto w-full relative`,children:[e.jsx("iframe",{src:`https://www.instagram.com/p/${L}/embed/`,title:r.title,frameBorder:"0",scrolling:"no",allowtransparency:"true",allow:"encrypted-media",className:"w-full h-full rounded-lg border-0",onError:S,style:{minHeight:U?"700px":"600px"}}),e.jsxs("div",{className:`
        ...
        ${l}
      `,onClick:N?void 0:i,children:[!a&&e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("span",{className:"w-3 h-3",children:v.icon}),e.jsx("span",{className:"text-xs font-medium",children:r.platform.toUpperCase()})]}),!a&&e.jsx("button",{onClick:M,className:`
          ...
          `,title:`Open on ${r.platform} to comment, like, or share`,children:e.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})})}),a&&!m?e.jsx("div",{className:N?"":"p-4",children:k()}):e.jsx(e.Fragment,{children:e.jsxs("div",{className:"relative aspect-video overflow-hidden",children:[x&&e.jsx("div",{className:`
              ...
              `,children:[e.jsx("svg",{className:"w-12 h-12 mb-2 opacity-50",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-9-6h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),e.jsx("span",{className:"text-sm",children:"Failed to load thumbnail"})]}),w&&e.jsxs(e.Fragment,{children:[e.jsx("img",{src:w,alt:r.title||"Video thumbnail",className:"w-full h-full object-cover transition-transform duration-500 group-hover:scale-110",loading:"lazy"}),e.jsx("div",{className:`
            ...
            `,onClick:b=>b.stopPropagation(),children:[e.jsx(ue,{className:"w-4 h-4"}),"Watch on ",r.platform]})]}),(!a||m||!N)&&e.jsxs("div",{className:"p-4 space-y-3",children:[e.jsx("h3",{className:`
        ...
        `})]})};X.displayName="VideoCard";const Q=s.memo(({currentPage:r,totalPages:t,hasNextPage:l,hasPreviousPage:c,onNext:C,onPrevious:w,onGoToPage:x,className:$=""})=>{const{darkMode:a}=W(),m=(()=>{const f=[],E=Math.max(2,r-2),i=Math.min(t-1,r+2);t>0&&f.push(1),E>2&&f.push("...");for(let M=E;M<=i;M++)M!==1&&M!==t&&f.push(M);return i<t-1&&f.push("..."),t>1&&f.push(t),f})(),h=`
  ...
  `,S=`
    ${h}
    ${a?"bg-blue-600/80 text-white border-blue-500/50 shadow-lg shadow-blue-500/25":"bg-blue-500/80 text-white border-blue-400/50 shadow-lg shadow-blue-500/25"}
    hover:shadow-xl hover:shadow-blue-500/30
  `,k=`
    ${h}
    ${a?"bg-gray-800/60 text-gray-300 border-gray-700/50 hover:bg-gray-700/80 hover:text-white":"bg-white/60 text-gray-700 border-gray-300/50 hover:bg-white/80 hover:text-gray-900"}
    hover:shadow-md
  `,u=`
    ${h}
    ${a?"bg-gray-800/30 text-gray-600 border-gray-700/30":"bg-gray-200/30 text-gray-400 border-gray-300/30"}
    cursor-not-allowed opacity-50
  `;return t<=1?null:e.jsxs("nav",{className:`flex items-center justify-center space-x-2 ${$}`,"aria-label":"Pagination",children:[e.jsxs("button",{onClick:w,disabled:!c,className:c?k:u,"aria-label":"Previous page",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"ml-1 hidden sm:inline",children:"Previous"})]}),e.jsx("div",{className:"flex items-center space-x-1",children:m.map((v,f)=>e.jsx(oe.Fragment,{children:v==="..."?e.jsx("span",{className:`
                px-2 py-2 text-sm
                ${a?"text-gray-500":"text-gray-400"}
              `,children:"..."}):e.jsx("button",{onClick:()=>x(v),className:v===r?S:k,"aria-label":`Page ${v}`,"aria-current":v===r?"page":void 0,children:v})},`${v}-${f}`))}),e.jsxs("button",{onClick:C,disabled:!l,className:l?k:u,"aria-label":"Next page",children:[e.jsx("span",{className:"mr-1 hidden sm:inline",children:"Next"}),e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})});Q.displayName="Pagination";const ee=s.memo(({videos:r,loading:t,error:l,currentPage:c,totalPages:C,totalVideos:w,hasNextPage:x,hasPreviousPage:$,onNext:a,onPrevious:y,onGoToPage:m,onRefresh:h,onVideoPlay:S,platform:k,isAdmin:u=!1,className:v=""})=>{const{darkMode:f}=W(),E=b=>{switch(b){case"tiktok":return"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6";default:return"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"}},i=()=>e.jsx("div",{className:E(k),children:Array.from({length:8}).map((b,V)=>e.jsxs("div",{className:`
    ...
    `,children:[e.jsx("svg",{className:"w-16 h-16 mx-auto mb-4 opacity-50",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"})}),e.jsx("h3",{className:"text-xl font-semibold mb-2",children:"No videos found"}),e.jsxs("p",{className:"text-sm opacity-80",children:["No ",k," videos are available at the moment."]})]});return e.jsxs("div",{className:`space-y-6 ${v}`,children:[(w>0||t)&&e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`text-sm ${f?"text-gray-400":"text-gray-600"}`,children:t?e.jsx("span",{children:"Loading videos..."}):e.jsxs("span",{children:["Showing ",(c-1)*50+1," - ",Math.min(c*50,w)," of ",w," videos"]})}),e.jsxs("div",{className:"flex items-center space-x-3",children:[h&&!t&&u&&e.jsx("button",{onClick:h,className:`
      ...
      `,children:[e.jsx("div",{className:`
        ...
        `}),e.jsxs("div",{className:"relative z-10",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsxs("div",{className:"flex items-center space-x-3",children:[e.jsx("div",{className:`
              ...
              ${x?"text-gray-400":"text-gray-600"}
            `,children:!h&&v>0&&e.jsxs("div",{className:"text-right",children:[e.jsxs("div",{className:`font-bold text-lg ${A.accentColor}`,children:[L.totalVideos.toLocaleString(),L.totalVideos!==v&&e.jsxs("span",{className:"text-xs opacity-60",children:["/",v.toLocaleString()]})]}),e.jsxs("div",{className:"text-xs",children:[L.totalVideos===1?"video":"videos",L.totalVideos!==v&&" (filtered)"]})]})})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center space-x-4",children:[a&&e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx("button",{onClick:b,disabled:h,className:`
                ...
                `,children:[e.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),e.jsx("span",{children:"Auto-updates daily at midnight"})]})]}),e.jsx("div",{className:"flex items-center space-x-4",children:u>1&&e.jsxs("div",{className:`
                  ...
                  backdrop-blur-sm
                `,children:["Page ",k," of ",u]})})]}),!h&&v>0&&!L.hasResults&&e.jsxs("div",{className:`
    ...
    `,te=async()=>{if(!t){I.error("Please log in first");return}try{await _.collection("users").doc(t.uid).set({email:t.email,displayName:t.displayName,role:"admin",createdAt:new Date,updatedAt:new Date},{merge:!0}),console.log("Admin role set successfully"),I.success("Admin role set! Please refresh the page.")}catch(o){console.error("Error setting admin role:",o),I.error("Failed to set admin role")}},q=s.useCallback((o,g)=>{E(j=>({...j,[o]:g}))},[]);return e.jsxs("div",{className:`
      min-h-screen
      ${r?"bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900":"bg-gradient-to-br from-blue-50 via-white to-purple-50"}
    `,children:[e.jsx("div",{className:"absolute inset-0 opacity-30",children:e.jsx("div",{className:`
          absolute inset-0
        ...
        `})}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("header",{className:"px-4 sm:px-6 lg:px-8 pt-8 pb-6",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[t&&!V&&e.jsxs("div",{className:"mb-4 p-4 bg-yellow-100 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-lg",children:[e.jsx("p",{className:"text-sm text-yellow-800 dark:text-yellow-200 mb-2",children:"Debug: User is not admin. Click to set admin role:"}),e.jsx("button",{onClick:te,className:"px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg text-sm font-medium",children:"Set Admin Role (Debug)"})]}),V&&e.jsx("div",{className:"flex justify-end mb-4",children:e.jsxs("button",{onClick:F,className:`
              ...
              `,children:"Discover trending videos from YouTube, TikTok, and Instagram all in one place"}),e.jsxs("div",{className:"max-w-2xl mx-auto mb-8",children:[e.jsxs("div",{className:"relative group",children:[e.jsx("input",{type:"text",value:a,onChange:o=>y(o.target.value),onFocus:()=>{a&&a.trim()&&k(!0)},placeholder:"Search videos by title, description, author, or platform... (Ctrl+K)",className:`
                      ...
                      ${a&&a.trim()?`shadow-2xl transform hover:scale-105 hover:-translate-y-1 
                    ...
                    ${a&&a.trim()?`scale-110 ${r?"text-blue-400":"text-blue-600"}`:`${r?"text-gray-400 group-hover:text-blue-400":"text-gray-500 group-hover:text-blue-600"}`}
                  `,children:e.jsx("svg",{className:"w-5 h-5 transition-transform duration-300 group-hover:rotate-12",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})}),a&&e.jsx("button",{onClick:()=>{y(""),k(!1),window.scrollTo({top:0,behavior:"smooth"})},className:`
                      ...
                      `,title:"Close search and return to top",children:e.jsx("svg",{className:"w-4 h-4 transition-transform duration-500 group-hover:rotate-90",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})}),!a&&e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("kbd",{className:`
                      ...
                      `,children:navigator.platform.includes("Mac")?"⌘":"Ctrl"}),e.jsx("kbd",{className:`
                        px-1.5 py-0.5 rounded text-xs font-mono
                        ${r?"bg-gray-700/50 border border-gray-600/50":"bg-gray-100/50 border border-gray-300/50"}
                      `,children:"K"})]}),!a&&!S&&e.jsx("button",{onClick:()=>{m.current&&m.current.focus()},className:`
                        absolute right-4 top-1/2 transform -translate-y-1/2 
                        ...
                        sm:hidden
                      `,title:"Start searching",children:"Search"}),a&&a.trim()&&e.jsx("div",{className:`
                  ...
                  `,children:e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("svg",{className:"w-4 h-4 animate-spin",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),e.jsxs("span",{className:"text-sm font-medium",children:["Searching for: ",e.jsxs("span",{className:"font-bold",children:['"',a,'"']})]}),e.jsx("div",{className:`
              ...
              shadow-lg
            `,children:K.map(o=>e.jsxs("button",{onClick:()=>c(o.id),className:re(o.id),children:[e.jsx("span",{className:"mr-2",children:o.icon}),o.label]},o.id))}),e.jsxs("div",{className:`
            ...
            `,children:[e.jsxs("button",{onClick:()=>$(!x),className:`
              ...
              `,children:[e.jsx("div",{className:"flex items-center justify-center space-x-2 mb-2",children:a&&a.trim()?e.jsxs(e.Fragment,{children:[e.jsx("svg",{className:"w-5 h-5 animate-pulse",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),e.jsxs("span",{className:"font-medium",children:['Search results for "',a,'" - Platforms with matches shown first']})]}):e.jsxs(e.Fragment,{children:[e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"})}),e.jsx("span",{className:"font-medium",children:"Platforms with filter results shown first"})]})}),e.jsxs("div",{className:"flex items-center justify-center space-x-1 text-xs opacity-75",children:[e.jsxs("span",{children:[Object.values(f).reduce((o,g)=>o+g,0)," total results"]}),a&&a.trim()&&e.jsxs(e.Fragment,{children:[e.jsx("span",{children:"•"}),e.jsx("span",{className:"animate-pulse",children:"Live search active"})]})]})]}),l==="all"&&e.jsx("div",{className:"space-y-16",children:P(f).map(o=>e.jsx(H,{platform:o,onVideoPlay:U,filters:u,searchQuery:a,onResultsChange:q},o))}),l!=="all"&&e.jsx(H,{platform:l,onVideoPlay:U,filters:u,searchQuery:a,onResultsChange:q})]})}),e.jsx("footer",{className:`
        ...
        `,children:e.jsxs("div",{className:`
            ...
            animate-floatSearch
          `,children:[e.jsxs("div",{className:"relative group",children:[e.jsx("input",{type:"text",value:a,onChange:o=>y(o.target.value),placeholder:"Search videos...",className:`
            ...
            `,children:[e.jsx("svg",{className:"w-4 h-4 animate-spin",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),e.jsxs("span",{className:"font-medium",children:["Searching for: ",e.jsxs("span",{className:"font-bold",children:['"',a,'"']})]}),e.jsx("div",{className:`
                w-2 h-2 rounded-full animate-pulse
                ${r?"bg-blue-400":"bg-blue-600"}
              `})]}),e.jsx("div",{className:`
            ...
            shadow-2xl
          `,children:e.jsxs("div",{className:"p-6",children:[e.jsxs("div",{className:"flex justify-between items-center mb-6",children:[e.jsx("h2",{className:`text-2xl font-bold ${r?"text-white":"text-gray-900"}`,children:"Add New Video"}),e.jsx("button",{onClick:()=>w(!1),className:`
                  ...
                  `,children:e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),e.jsxs("form",{onSubmit:O,className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Platform"}),e.jsxs("select",{name:"platform",value:i.platform,onChange:T,className:`
                    ...
                    `,placeholder:"Enter thumbnail URL"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Views"}),e.jsx("input",{type:"number",name:"views",value:i.views,onChange:T,min:"0",className:`
                      ...
                      `,placeholder:"0"})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Likes"}),e.jsx("input",{type:"number",name:"likes",value:i.likes,onChange:T,min:"0",className:`
                        ...
                        ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                        focus:outline-none focus:ring-2 focus:ring-blue-500
                      `,placeholder:"0"})]})]}),e.jsxs("div",{className:"flex justify-end space-x-3 pt-4",children:[e.jsx("button",{type:"button",onClick:()=>w(!1),className:`
