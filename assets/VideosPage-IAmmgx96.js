import{s as ae,r as s,t as W,j as e,n as oe,A as J,b8 as O,y as B}from"./index-Dj8VjIVn.js";import{V as Z}from"./videosService-BQg_Y8rU.js";import{P as le}from"./PageHeader-BbX-RnQc.js";/* empty css                   */const ne=r=>{const o=ae();s.useEffect(()=>{const i=`${r} | AIWaverider`;document.title=i;const C=window.history.state;C&&window.history.replaceState({...C,title:i},i,o.pathname+o.search+o.hash)},[r,o])},ie=(r,o=1)=>{const[l,i]=s.useState([]),[C,v]=s.useState(!1),[g,$]=s.useState(null),[t,y]=s.useState(o),[u,b]=s.useState(0),[P,j]=s.useState(0),[d,w]=s.useState(!1),[p,A]=s.useState(!1),n=s.useRef(new Map),M=s.useRef(!0),N=s.useCallback(async x=>{if(!r||typeof r!="string"||r.trim()===""){i([]),v(!1),$(null);return}const c=`${r}-${x}`;if(n.current.has(c)){const m=n.current.get(c);i(m.videos),b(m.totalPages),j(m.totalVideos),w(m.hasNextPage),A(m.hasPreviousPage),y(x);return}v(!0),$(null);try{const m=await Z.getVideosByPlatform(r,x),V={videos:m.videos||[],totalPages:m.totalPages||0,totalVideos:m.totalVideos||0,hasNextPage:m.hasNextPage||!1,hasPreviousPage:m.hasPreviousPage||!1};n.current.set(c,V),i(V.videos),b(V.totalPages),j(V.totalVideos),w(V.hasNextPage),A(V.hasPreviousPage),y(x)}catch(m){$(m.message),console.error(`Error fetching ${r} videos:`,m),i([]),b(0),j(0),w(!1),A(!1)}finally{v(!1)}},[r]),f=s.useCallback(()=>{if(d){const x=t+1;N(x)}},[t,d,N]),S=s.useCallback(()=>{if(p){const x=t-1;N(x)}},[t,p,N]),L=s.useCallback(x=>{x>=1&&x<=u&&N(x)},[u,N]),T=s.useCallback(()=>{if(!r)return;const x=`${r}-${t}`;n.current.delete(x),N(t)},[r,t,N]),z=s.useCallback(()=>{n.current.clear()},[]);return s.useEffect(()=>{r&&typeof r=="string"&&r.trim()!==""&&M.current&&(M.current=!1,N(o))},[r,o,N]),s.useEffect(()=>{r&&typeof r=="string"&&r.trim()!==""?(y(1),M.current=!0,$(null)):(i([]),v(!1),$(null),b(0),j(0),w(!1),A(!1),y(1))},[r]),{videos:l,loading:C,error:g,currentPage:t,totalPages:u,totalVideos:P,hasNextPage:d,hasPreviousPage:p,nextPage:f,previousPage:S,goToPage:L,refresh:T,clearCache:z,isEmpty:l.length===0&&!C,isFirstPage:t===1,isLastPage:t===u}},de=(r={})=>{const[o,l]=s.useState(!1),[i,C]=s.useState(!1),v=s.useRef(null),g=s.useRef(null),{threshold:$=.1,rootMargin:t="50px",triggerOnce:y=!0,enabled:u=!0}=r,b=s.useCallback(()=>{!u||!v.current||(g.current=new IntersectionObserver(P=>{const[j]=P,d=j.isIntersecting;l(d),d&&!i&&(C(!0),y&&g.current&&g.current.unobserve(v.current))},{threshold:$,rootMargin:t}),g.current.observe(v.current))},[$,t,y,u,i]);return s.useEffect(()=>(b(),()=>{g.current&&g.current.disconnect()}),[b]),s.useEffect(()=>{!u&&g.current?(g.current.disconnect(),l(!1),y&&C(!1)):u&&!g.current&&b()},[u,b,y]),{targetRef:v,isIntersecting:o,hasIntersected:i,shouldLoad:u&&(y?i:o)}},ce=(r,o={})=>{const[l,i]=s.useState(null),[C,v]=s.useState(!1),[g,$]=s.useState(!1),{targetRef:t,shouldLoad:y}=de(o);return s.useEffect(()=>{if(!y||!r||l)return;v(!0),$(!1);const u=new Image;return u.onload=()=>{i(r),v(!1)},u.onerror=()=>{$(!0),v(!1)},u.src=r,()=>{u.onload=null,u.onerror=null}},[y,r,l]),{targetRef:t,imageSrc:l,imageLoading:C,imageError:g,shouldLoad:y}};function ue({title:r,titleId:o,...l},i){return s.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor","aria-hidden":"true","data-slot":"icon",ref:i,"aria-labelledby":o},l),r?s.createElement("title",{id:o},r):null,s.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"}))}const me=s.forwardRef(ue),H={youtube:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"})}),tiktok:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"})}),instagram:e.jsx("svg",{viewBox:"0 0 24 24",className:"w-full h-full",fill:"currentColor",children:e.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})},xe=r=>{if(!r||typeof r!="string")return null;const o=/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/,l=r.match(o);return l?l[1]:null},he=r=>{if(!r||typeof r!="string")return null;const o=/tiktok\.com\/.*\/video\/(\d+)/,l=r.match(o);return l?l[1]:null},ge=r=>{if(!r||typeof r!="string")return null;const o=/instagram\.com\/(?:p|reel)\/([A-Za-z0-9_-]+)/,l=r.match(o);return l?l[1]:null},X=({video:r,onPlay:o,className:l=""})=>{const{darkMode:i}=W(),{targetRef:C,imageSrc:v,imageLoading:g,imageError:$}=ce(r.thumbnailUrl,{threshold:.1,rootMargin:"100px"}),[t,y]=s.useState(r.platform.toLowerCase()==="instagram"),[u,b]=s.useState(!1);s.useCallback(()=>{y(!0),b(!1)},[]);const P=s.useCallback(()=>{b(!0)},[]),j=()=>{if(!t||u)return null;const{platform:f,originalUrl:S}=r;if(!S||typeof S!="string")return b(!0),null;switch(f.toLowerCase()){case"youtube":{const L=xe(S);return L?e.jsx("div",{className:"aspect-video w-full",children:e.jsx("iframe",{src:`https://www.youtube.com/embed/${L}?autoplay=1&rel=0`,title:r.title,frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full rounded-lg",onError:P})}):(b(!0),null)}case"tiktok":{const L=he(S);return L?e.jsx("div",{className:"aspect-[9/16] w-full max-w-lg mx-auto",children:e.jsx("iframe",{src:`https://www.tiktok.com/embed/v2/${L}?autoplay=1`,title:r.title,frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,className:"w-full h-full rounded-lg",onError:P,style:{minHeight:"700px"}})}):(b(!0),null)}case"instagram":{const L=ge(S);if(!L)return b(!0),null;const T=S.includes("/reel/"),z=T?"aspect-[9/16]":"aspect-square",x=T?"max-w-md":"max-w-lg";return e.jsxs("div",{className:`${z} ${x} mx-auto w-full relative`,children:[e.jsx("iframe",{src:`https://www.instagram.com/p/${L}/embed/`,title:r.title,frameBorder:"0",scrolling:"no",allowtransparency:"true",allow:"encrypted-media",className:"w-full h-full rounded-lg border-0",onError:P,style:{minHeight:T?"700px":"600px"}}),e.jsxs("div",{className:`
        ...
        ${l}
      `,onClick:N?void 0:n,children:[!t&&e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("span",{className:"w-3 h-3",children:w.icon}),e.jsx("span",{className:"text-xs font-medium",children:r.platform.toUpperCase()})]}),!t&&e.jsx("button",{onClick:M,className:`
          ...
          `,title:`Open on ${r.platform} to comment, like, or share`,children:e.jsx("svg",{className:"w-3 h-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})})}),t&&!u?e.jsx("div",{className:N?"":"p-4",children:j()}):e.jsx(e.Fragment,{children:e.jsxs("div",{className:"relative aspect-video overflow-hidden",children:[g&&e.jsx("div",{className:`
              ...
              `,children:[e.jsx("svg",{className:"w-12 h-12 mb-2 opacity-50",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-9-6h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),e.jsx("span",{className:"text-sm",children:"Failed to load thumbnail"})]}),v&&e.jsxs(e.Fragment,{children:[e.jsx("img",{src:v,alt:r.title||"Video thumbnail",className:"w-full h-full object-cover transition-transform duration-500 group-hover:scale-110",loading:"lazy"}),e.jsx("div",{className:`
                ...
                `,children:e.jsx("div",{className:`
                    ...
                    shadow-lg
                  `,children:e.jsx("svg",{className:`w-8 h-8 ${w.color}`,fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]})]})}),u&&e.jsxs("div",{className:"p-4 text-center",children:[e.jsxs("p",{className:`text-sm mb-3 ${i?"text-gray-400":"text-gray-600"}`,children:["Unable to embed video. Click below to watch on ",r.platform,"."]}),e.jsxs("a",{href:r.originalUrl,target:"_blank",rel:"noopener noreferrer",className:`
            ...
            `,onClick:f=>f.stopPropagation(),children:[e.jsx(me,{className:"w-4 h-4"}),"Watch on ",r.platform]})]}),(!t||u||!N)&&e.jsxs("div",{className:"p-4 space-y-3",children:[e.jsx("h3",{className:`
        ...
        `})]})};X.displayName="VideoCard";const Q=s.memo(({currentPage:r,totalPages:o,hasNextPage:l,hasPreviousPage:i,onNext:C,onPrevious:v,onGoToPage:g,className:$=""})=>{const{darkMode:t}=W(),u=(()=>{const p=[],A=Math.max(2,r-2),n=Math.min(o-1,r+2);o>0&&p.push(1),A>2&&p.push("...");for(let M=A;M<=n;M++)M!==1&&M!==o&&p.push(M);return n<o-1&&p.push("..."),o>1&&p.push(o),p})(),b=`
  ...
  `;return o<=1?null:e.jsxs("nav",{className:`flex items-center justify-center space-x-2 ${$}`,"aria-label":"Pagination",children:[e.jsxs("button",{onClick:v,disabled:!i,className:i?j:d,"aria-label":"Previous page",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"ml-1 hidden sm:inline",children:"Previous"})]}),e.jsx("div",{className:"flex items-center space-x-1",children:u.map((w,p)=>e.jsx(oe.Fragment,{children:w==="..."?e.jsx("span",{className:`
                px-2 py-2 text-sm
                ${t?"text-gray-500":"text-gray-400"}
              `,children:"..."}):e.jsx("button",{onClick:()=>g(w),className:w===r?P:j,"aria-label":`Page ${w}`,"aria-current":w===r?"page":void 0,children:w})},`${w}-${p}`))}),e.jsxs("button",{onClick:C,disabled:!l,className:l?j:d,"aria-label":"Next page",children:[e.jsx("span",{className:"mr-1 hidden sm:inline",children:"Next"}),e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})});Q.displayName="Pagination";const ee=s.memo(({videos:r,loading:o,error:l,currentPage:i,totalPages:C,totalVideos:v,hasNextPage:g,hasPreviousPage:$,onNext:t,onPrevious:y,onGoToPage:u,onRefresh:b,onVideoPlay:P,platform:j,isAdmin:d=!1,className:w=""})=>{const{darkMode:p}=W(),A=f=>{switch(f){case"tiktok":return"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6";default:return"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"}},n=()=>e.jsx("div",{className:A(j),children:Array.from({length:8}).map((f,S)=>e.jsxs("div",{className:`
            rounded-2xl overflow-hidden
            ${p?"bg-gray-800/40 backdrop-blur-xl border border-gray-700/30":"bg-white/40 backdrop-blur-xl border border-white/30"}
            animate-pulse
          `,children:[e.jsx("div",{className:`aspect-video ${p?"bg-gray-700":"bg-gray-300"}`}),e.jsxs("div",{className:"p-4 space-y-3",children:[e.jsx("div",{className:`h-4 rounded ${p?"bg-gray-700":"bg-gray-300"}`}),e.jsx("div",{className:`h-3 rounded w-3/4 ${p?"bg-gray-700":"bg-gray-300"}`}),e.jsx("div",{className:`h-3 rounded w-1/2 ${p?"bg-gray-700":"bg-gray-300"}`})]})]},S))}),M=()=>e.jsxs("div",{className:`
    ...
    `,se=async()=>{if(!o){B.error("Please log in first");return}try{await O.collection("users").doc(o.uid).set({email:o.email,displayName:o.displayName,role:"admin",createdAt:new Date,updatedAt:new Date},{merge:!0}),console.log("Admin role set successfully"),B.success("Admin role set! Please refresh the page.")}catch(a){console.error("Error setting admin role:",a),B.error("Failed to set admin role")}},Y=s.useCallback((a,h)=>{A(k=>({...k,[a]:h}))},[]);return e.jsxs("div",{className:`min-h-screen pb-16 ${r?"dark bg-[#2D1846]":"bg-gray-50"} bg-gradient-to-br from-[#4158D0] via-[#C850C0] to-[#FFCC70] stars-pattern`,children:[e.jsx(le,{}),e.jsx("div",{className:"absolute inset-0 opacity-30",children:e.jsx("div",{className:`
          absolute inset-0
        ...
        `})}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("header",{className:"px-4 sm:px-6 lg:px-8 pt-8 pb-6",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[o&&!S&&e.jsxs("div",{className:"mb-4 p-4 bg-yellow-100 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-lg",children:[e.jsx("p",{className:"text-sm text-yellow-800 dark:text-yellow-200 mb-2",children:"Debug: User is not admin. Click to set admin role:"}),e.jsx("button",{onClick:se,className:"px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg text-sm font-medium",children:"Set Admin Role (Debug)"})]}),S&&e.jsx("div",{className:"flex justify-end mb-4",children:e.jsxs("button",{onClick:G,className:`
              ...
              `,children:"Discover trending videos from YouTube, TikTok, and Instagram all in one place"}),e.jsxs("div",{className:"max-w-2xl mx-auto mb-8",children:[e.jsxs("div",{className:"relative group",children:[e.jsx("input",{type:"text",value:t,onChange:a=>y(a.target.value),onFocus:()=>{t&&t.trim()&&j(!0)},placeholder:"Search videos by title, description, author, or platform... (Ctrl+K)",className:`
                    ...
                    ${t&&t.trim()?`scale-110 ${r?"text-blue-400":"text-blue-600"}`:`${r?"text-gray-400 group-hover:text-blue-400":"text-gray-500 group-hover:text-blue-600"}`}
              ...
              shadow-lg
            `,children:re.map(a=>e.jsxs("button",{onClick:()=>i(a.id),className:te(a.id),children:[e.jsx("span",{className:"mr-2",children:a.icon}),a.label]},a.id))}),e.jsxs("div",{className:`
                    ...
                    `,children:"Active"})]}),e.jsx("svg",{className:`w-5 h-5 transition-transform duration-200 ${g?"rotate-180":""}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M19 9l-7 7-7-7"})})]}),g&&e.jsxs("div",{className:"px-6 pb-6 space-y-6 border-t border-gray-200/20",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:`block text-sm font-medium ${r?"text-gray-300":"text-gray-700"}`,children:"Author/Creator"}),e.jsx("input",{type:"text",value:d.author,onChange:a=>c("author",a.target.value),placeholder:"Search by author name...",className:`
                        ...
                        `,children:x.map(a=>e.jsx("option",{value:a.id,children:a.label},a.id))})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:`block text-sm font-medium ${r?"text-gray-300":"text-gray-700"}`,children:"Views Range"}),e.jsxs("div",{className:"flex space-x-2",children:[e.jsx("input",{type:"number",value:d.minViews,onChange:a=>c("minViews",a.target.value),placeholder:"Min views",className:`
                          ...
                          `}),e.jsx("input",{type:"number",value:d.maxLikes,onChange:a=>c("maxLikes",a.target.value),placeholder:"Max likes",className:`
                            ...
                            focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                            transition-all duration-200
                          `})]})]}),e.jsx("div",{className:"flex items-end",children:e.jsx("button",{onClick:m,disabled:!V(),className:`
        ...
        `,children:e.jsxs("div",{className:`
          ...
          `,children:e.jsxs("div",{className:"p-6",children:[e.jsxs("div",{className:"flex justify-between items-center mb-6",children:[e.jsx("h2",{className:`text-2xl font-bold ${r?"text-white":"text-gray-900"}`,children:"Add New Video"}),e.jsx("button",{onClick:()=>v(!1),className:`
                  ...
                  `,children:e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),e.jsxs("form",{onSubmit:K,className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Platform"}),e.jsxs("select",{name:"platform",value:n.platform,onChange:U,className:`
                      w-full px-3 py-2 rounded-lg border
                      ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                      focus:outline-none focus:ring-2 focus:ring-blue-500
                    `,children:[e.jsx("option",{value:"youtube",children:"YouTube"}),e.jsx("option",{value:"tiktok",children:"TikTok"}),e.jsx("option",{value:"instagram",children:"Instagram"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2",children:"Title (Optional)"}),e.jsx("input",{type:"text",name:"title",value:n.title,onChange:U,placeholder:"Enter video title (will be auto-generated if empty)",className:`
                      w-full px-3 py-2 rounded-lg border
                    ...
                    `})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Author Name"}),e.jsx("input",{type:"text",name:"authorName",value:n.authorName,onChange:U,className:`
                      w-full px-3 py-2 rounded-lg border
                      ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                      focus:outline-none focus:ring-2 focus:ring-blue-500
                    `,placeholder:"Enter author name"})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Username"}),e.jsx("input",{type:"text",name:"username",value:n.username,onChange:U,className:`
                      w-full px-3 py-2 rounded-lg border
                      ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                      focus:outline-none focus:ring-2 focus:ring-blue-500
                    `,placeholder:"Enter username"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2",children:"Video URL *"}),e.jsx("input",{type:"url",name:"originalUrl",value:n.originalUrl,onChange:U,required:!0,placeholder:"https://www.youtube.com/watch?v=... or https://www.tiktok.com/... or https://www.instagram.com/...",className:`
                      w-full px-3 py-2 rounded-lg border
                      ${r?"bg-gray-700 border-gray-600 text-white placeholder-gray-400":"bg-white border-gray-300 text-gray-900 placeholder-gray-500"}
                      focus:ring-2 focus:ring-blue-500 focus:border-transparent
                    `})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Thumbnail URL"}),e.jsx("input",{type:"url",name:"thumbnailUrl",value:n.thumbnailUrl,onChange:U,className:`
                      w-full px-3 py-2 rounded-lg border
                      ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                      focus:outline-none focus:ring-2 focus:ring-blue-500
                    `,placeholder:"Enter thumbnail URL"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Views"}),e.jsx("input",{type:"number",name:"views",value:n.views,onChange:U,min:"0",className:`
                        w-full px-3 py-2 rounded-lg border
                        ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                        focus:outline-none focus:ring-2 focus:ring-blue-500
                      `,placeholder:"0"})]}),e.jsxs("div",{children:[e.jsx("label",{className:`block text-sm font-medium mb-2 ${r?"text-gray-300":"text-gray-700"}`,children:"Likes"}),e.jsx("input",{type:"number",name:"likes",value:n.likes,onChange:U,min:"0",className:`
                        w-full px-3 py-2 rounded-lg border
                        ${r?"bg-gray-700/50 border-gray-600 text-white":"bg-white border-gray-300 text-gray-900"}
                        focus:outline-none focus:ring-2 focus:ring-blue-500
                    ...
                    `,children:N?"Adding...":"Add Video"})]})]})]})})})]})};export{we as default};
